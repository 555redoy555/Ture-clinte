...
const Banner = () => {
    return (
        <div className="relative">
            <img
                className="w-full"
                src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0b/d4/8f/11/tajhat-palace-front-right.jpg?w=1200&h=-1&s=1"
                    ...
                    <div className="flex justify-center items-center">
                        <div className="mx-6">
                            ...
                            <p className="text-xs md:text-lg lg:text-xl text-white font-bold">
                                Explore the varietys of tour we have to offer for
                                your
                            </p>
                            <Link
                                to="/shop"
